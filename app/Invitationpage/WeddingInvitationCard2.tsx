...
const WeddingInvitationCard2: React.FC<WeddingInvitationCard1Props> = ({
  width = 550,
  height = 650,
  groomName,
  groomParents,
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/image/imageBG5.jpg')",
    ...
    >
      <div className="flex justify-center" style={{ width: `${width}px` }}>
        <div className="text-center w-[80%]">
          ...
          {/* Tên cô dâu chú rể */}
          <p className="font-[Great_Vibes] text-[40px] tracking-[3px] font-normal mb-1 capitalize">
            {withDefault(groomName, "Hà Xuân Vinh")}
          </p>
          <p className="font-[Great_Vibes] text-[28px] tracking-wide font-normal mb-1 capitalize">
            &amp;
          </p>
          <p className="font-[Great_Vibes] text-[40px] tracking-[3px] font-normal mb-8 capitalize">
...
export default WeddingInvitationCard2;
