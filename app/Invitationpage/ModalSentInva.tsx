...
interface ModalSentInvaProps {
  isOpen: boolean;
  onClose: () => void;
  onUpgrade: () => void;
}

const ModalSentInva: React.FC<ModalSentInvaProps> = ({ isOpen, onClose, onUpgrade }) => {
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden animate-scaleIn">
        ...
        <div className="pt-12 pb-6 px-6">
          ...
          <p className="text-gray-600 text-center mb-6 leading-relaxed">
            Tài khoản của bạn không có quyền gửi thiệp mời
