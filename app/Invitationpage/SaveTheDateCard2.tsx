...
const SaveTheDateCard2: React.FC<SaveTheDateCard1Props> = ({width = 550,height = 650,groomName,brideName,nameCutomer,backgroundImage}) => {
  return (
    <div
...
export default SaveTheDateCard2;
