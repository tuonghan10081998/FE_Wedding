...
import InvitionCardEvent from "~/InvitationCard/InvitionCardEvent"; // Import component Event mới
...
const InvitationCard: React.FC = () => {
  ...
  useEffect(() => {
    switch (isThiep) {
      case "1":
        setViews([
          <SaveTheDateCard1 type={"SaveTheDateCard1"} />,
          <WeddingInvitationCard1 type={"WeddingInvitationCard1"} />,
          <WeddingInvitation1 type={"WeddingInvitation1"} />
        ]);
        break;
      case "2":
        setViews([
          <SaveTheDateCard2 type={"SaveTheDateCard2"} />,
          <WeddingInvitationCard2 type={"WeddingInvitationCard2"} />,
          <WeddingInvitation2 type={"WeddingInvitation2"} />
        ]);
        break;
      case "3":
        setViews([
          <SaveTheDateCard3 type={"SaveTheDateCard3"} />,
          <WeddingInvitationCard3 type={"WeddingInvitationCard3"} />,
          <WeddingInvitation3 type={"WeddingInvitation3"} />
        ]);
        break;
      case "4":
        setViews([
          <SaveTheDateCard4 type={"SaveTheDateCard4"} />,
          <WeddingInvitationCard4 type={"WeddingInvitationCard4"} />,
          <WeddingInvitation4 type={"WeddingInvitation4"} />
        ]);
        break;
      case "5":
        setViews([<EventInvitationCard type={"EventInvitationCard"} />]);
        break;
      default:
        setViews([]);
    }
  ...
  // Kiểm tra xem có phải thiệp Event không
  const isEventInvitation = isThiep === "5";
    ...
    <div id="page_loader2" className="page_loader2">
      ...
      {isEventInvitation ? (
        <InvitionCardEvent
          views={views}
          data={data}
          checkxttruoc={xemthiepsave === "true"}
          guestid={guestid ?? ""}
          guest={isGuest}
          phone={isPhone}
          parentcount={isParentCount}
