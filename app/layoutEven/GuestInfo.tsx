...
const GuestInfoModal: React.FC<GuestInfoModalProps> = ({  table,onClickSeat ,onDelete}) => {
  ...
  return (
      ...
      <div className="bg-white shadow-md rounded-lg max-w-3xl w-full p-2 relative">
        ...
        <div>
          ...
          <p className="break-words text-gray-700 text-lg border border-gray-300 rounded-md px-3 py-2 bg-white">
            {table.mail ?? ""}
          </p>
        </div>
           <div>
