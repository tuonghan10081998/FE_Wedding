      ...
      <div className='gap-4'>
         {/* Nhập số bàn */}
          <label className="flex items-center gap-3 bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-300 hover:border-blue-400 transition-colors duration-200">
            <span className="text-gray-800 font-medium">Số bàn / hàng:</span>
            <input
              type="number"
              value={numberDay}
            ...
            <div onClick={() => onAddTable(4,parseInt(selectedValue),side)} className="flex flex-col items-center">
              <div className="icon-item">
                <svg className="icon-svg w-20 h-auto" viewBox="0 0 80 50" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#9B9B9B" strokeWidth="1.5">
                  ...
                  <line x1="32" y1="35" x2="48" y2="35" stroke="#9B9B9B" strokeWidth="1.5" strokeLinecap="round"></line>
                </svg>
                <span className="label-text">Ghế đơn</span>
              </div>
            </div>
              <div  className="flex flex-col items-center">
