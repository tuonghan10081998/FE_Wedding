...
const LayoutModalDelete: React.FC<LayoutModalDeleteProps> = ({ isOpen, onClose, onConfirm,projectName }) => {
      ...
      <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-30">
        <div className="bg-white rounded-lg shadow-lg w-96 p-6">
          ...
          <p className="mt-4 text-gray-700 leading-relaxed mb-6" >
            Bạn có chắc chắn xoá  dự án <span className="text-red-500 text-[18px] font-bold">{projectName ??""}</span> này ! 
        </p>
